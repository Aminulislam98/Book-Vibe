  ...
  return (
    <>
      <button
        ...
        className="flex items-center  gap-2 text-black hover:text-[#b794f4] transition-colors duration-200 text-base font-medium  mx-auto w-full pb-5 cursor-pointer max-w-5xl pt-5"
      >
